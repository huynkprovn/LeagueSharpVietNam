...
namespace HuyNKSeries
{
    ...
    public static class AdvancedTS
    {
        ...
        {
            if (_config != null && _config.Item("AdvancedTS" + hero.ChampionName + "Priority") != null)
            {
                var p = _config.Item("AdvancedTS" + hero.ChampionName + "Priority").GetValue<Slider>();
                p.Value = Math.Max(1, Math.Min(5, newPriority));
                _config.Item("AdvancedTS" + hero.ChampionName + "Priority").SetValue(p);
            }
        }
        ...
        public static float GetPriority(Obj_AI_Hero hero)
        {
            ...
            if (_config != null && _config.Item("AdvancedTS" + hero.ChampionName + "Priority") != null)
            {
                p = _config.Item("AdvancedTS" + hero.ChampionName + "Priority").GetValue<Slider>().Value;
            }
        ...
        public static void AddToMenu(Menu Config)
        {
            ...
            {
                Config.AddItem(
                    new MenuItem("AdvancedTS" + enemy.ChampionName + "Priority", enemy.ChampionName).SetShared()
                        .SetValue(
                            new Slider(
